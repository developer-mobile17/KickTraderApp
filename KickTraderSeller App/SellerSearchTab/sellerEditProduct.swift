...
class sellerEditProduct: UIViewController {
    ...
    //TODO:- Value Pass From popupView
    var strShoeImg: String!
    var strShoeName: String!
    var strShoeCategory: String!
    var strGender: String!
    var strShoePrice: String!
    var strShoeBrand: String!
    var strShoedesc: String!
    ...
    override func viewDidLoad() {
        ...
        self.txfName.text = strShoeName
        self.txfPrice.text = strShoePrice
        self.txvDescription.text = strShoedesc
        self.btnBrand.setTitle(strShoeBrand, for: .normal)
            ...
            ProgressHUD.dismiss()
             ...
             //   print("Categories are: ",self.arrCategories)
               ...
               // print("Brands are: ",arrbrands)
                ...
                self.arrcolor = ((json as! Welcome).array?.color!)!
                
                self.arrsize = ((json as! Welcome).array?.size!)!
...
extension sellerEditProduct: UITableViewDataSource,UITableViewDelegate {
...
extension sellerEditProduct : UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    func OpenCamera(){
